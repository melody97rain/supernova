...
mkdir /root/.acme.sh
curl https://raw.githubusercontent.com/‎melody97rain/supernova/main/acme.sh -o /root/.acme.sh/acme.sh
...
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/supernova/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/supernova/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/supernova/main/menu/xraay2.sh"
chmod +x port-xray
chmod +x certv2ray
chmod +x trojaan
chmod +x xraay
